...
namespace Duilib {
	...
	class DUILIB_API CDelegateBase : public IDelegate
	{
	public:
	...
	class DUILIB_API CDelegateStatic: public CDelegateBase
	{
	public:
	...
	class DUILIB_API CDelegate : public CDelegateBase
	{
