...
namespace Duilib
{
	...
	class DUILIB_API TStdPtrArray : public CStdPtrArray
	{
	public:
	...
	class DUILIB_API TStdValArray : public CStdValArray
	{
	public:
	...
	template<typename T = LPVOID>
	class DUILIB_API TStdStringPtrMap : public CStdStringPtrMap
	{
	public:
