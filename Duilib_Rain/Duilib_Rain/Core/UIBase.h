...
void DUILIB_API DUI__Trace(LPCSTR pstrFormat,...);
...
public:
	...
	HWND Create(HWND hwndParent, LPCTSTR pstrName, const RECT rc, DWORD dwStyle = UI_WNDSTYLE_FRAME, DWORD dwExStyle = 0L, HMENU hMenu = NULL);
